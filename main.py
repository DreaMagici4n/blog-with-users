...
class Comments(db.Model):
    ...
    post_id = db.Column(db.Integer, db.ForeignKey("blog-post.id"))
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        new_comment = Comments(text=form.comment.data, comment_author=current_user, parent_post=requested_post)
